/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9608984f1966c72cce6cbd9580cd830b)
...
interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SYNC_TOKEN_TTL_SECONDS" | "SELF_HOSTED" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "SYNC_TOKEN_SECRET" | "AUTH_EMAIL_FROM" | "POLAR_ACCESS_TOKEN" | "POLAR_WEBHOOK_SECRET" | "POLAR_STARTER_PRODUCT_ID" | "POLAR_SANDBOX">> {}
}
declare module "*.sql" {
	const value: string;
